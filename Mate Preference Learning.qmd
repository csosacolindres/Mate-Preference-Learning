...
# Methods
methodList <- c("randomMethod", "absoluteMethod", "absImpMethod")
...
prefLearningCycles <- 50
prefTestingCycles <- 1000
# cor test cycles to find converging val. 
...
mpUpdate <- function(method = "method", pref, imp) {
