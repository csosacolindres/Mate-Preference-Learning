...
# plot r 
ggplot(plotCors, mapping = aes(x = trial, y = r, color = method)) + geom_line() + labs(x = "Mate Preference Adjustments", y = "Cor. Between Real and Agent Mate Preferences", title = "Performance of Mate Preference Adjusting Methods" + guides())
